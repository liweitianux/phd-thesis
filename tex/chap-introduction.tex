...
\begin{figure}[!htp]
  ...
  \bicaption[宇宙的演化历史]{%
    宇宙从大爆炸到今天的演化历史。
    \textcopyright{} BICEP2 Collaboration/CERN/NASA; CC0 1.0.
  }{%
...
\begin{figure}[!htp]
  ...
  \bicaption[宇宙的黑暗时期与再电离时期示意图]{%
    ...
    上方的粗曲线显示了理论预测的 \SI{21}{\cm} 信号的强度。
    \textcopyright{} DARE,
    \url{http://lunar.colorado.edu/dare/science.html},
    (2018-09-23).
  }{%
