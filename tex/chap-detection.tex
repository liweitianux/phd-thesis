...
这些人工源主要有：\ac{am}和\ac{fm}广播、卫星电视和通信、\ac{gps}信号、
...
还需要发展更加有效的\acl{ionosphere}校准算法 \cite{intema2009,deGasperin2015}。
...
每根天线的性能都不可能完全相同，导致所形成的\acl{sb}存在很多不确定因素，
...
因此，如果未能全面地校准\acl{sb}，那么后续对其他仪器效应的校准、亮点源剥离、
