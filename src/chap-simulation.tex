...
因此，我们选取 $\Delta M_c = \SI{e13}{\solarmass}$ \cite{cassano2005}，
...
这群高能电子的数密度非常低，约为 \SI{e-10}{\per\cm\cubed} 量级，
但是能量非常高 (\acl{g} $\ac{g} > \num{e3}$)，
其能量密度能达到 \ac{icm} 热成分的能量密度的 $\lesssim$\,1\%。
这些电子可以在多种高能过程中产生并被注入 \ac{icm}，
主要的注入过程包括\ac{quasar}和射电星系的 \ac{agn} 活动、恒星形成、
\ac{sn}爆发、\ac{galactic-wind}。
详见 \citeay{blasi2007}, \citeay{feretti2012}, \citeay{brunetti2014}
等综述文。
当星系团经历\ac{m-major}时，整个 \ac{icm} 中都将产生剧烈的\ac{turbulence}，
就地加速\ac{e-primary}至极高的能量，从而形成弥散的\ac{rh}。
