...
改进\ac{rh}辐射的建模并获得更加逼真的\ac{rh}图像和频谱信息非常必要。
...
没有提供单个星系团的形成历史的信息。
扩展 Press--Schechter 理论 \cite{bond1991,lacey1993} 对这个问题给出了一个解决方案。
...
\begin{enumerate}
  \item \acl{syn-em}在频率 $\nu$ 的值 $\ac{syn-em}(\nu)$
    ...
    $n_e(\ac{g}, t_0)$ 的方法类似，
    即在没有并合引起的湍流加速的情况下求解 Fokker--Planck 方程得到。
