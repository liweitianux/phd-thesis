...
按幂律形式外延得到 \cite{wang2010,bonaldi2015}：
\begin{equation}
  T_b^{\R{syn}}(\B{\hat{r}}, \nu)
...
本工作利用了该谱指数分布图来确定上式中的 $\alpha_{\R{syn}}(\B{\hat{r}})$.
...
以及在\autoref{chap:cdae}用于研发和评估 EoR 信号分离新算法.
