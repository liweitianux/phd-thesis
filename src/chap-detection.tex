...
\end{equation}
其中 $\tilde{I}^*$ 为 $\tilde{I}$ 的\ac{c-conj}.
...
因此，\ac{fgavd}法通过识别并避开受到前景污染的区域，从而实现提取 EoR 信号的目标.
...
上述两类方法均有各自的优缺点.
\ac{fgrm}法的优点是能够保留 EoR 信号的全部信息，
但缺点是可能无法准确扣除前景污染或者将部分 EoR 信号错误扣除，导致结果出现一定的偏差.
\ac{fgavd}法的优点是可以有效避免前景污染对 EoR 探测结果产生的可能偏差，
...
再利用\ac{fgavd}法在二维功率谱上提取 EoR 信号 \cite{datta2010}.
