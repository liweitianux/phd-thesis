...
\begin{equation}
  \acs{coef-absorption} = \frac{3 \acs{speed-light}^2}{32\Cpi \nu_0}
    \frac{A_{21} n_{\R{HI}} h}{\acs{kb} \acs{T-spin}} \phi(\nu) ,
\end{equation}
...
\begin{figure}[tbp]
  ...
  \bicaption[CMB 辐射经过中性氢云的辐射转移示意图]{%
    CMB 辐射经过中性氢云的辐射转移示意图：
...
在实际观测中，需要考虑 \ac{cmb} 辐射经过中性氢云的转移过程，
如\autoref{fig:21cm-cmb-rt} 所示.
考虑一团处于热平衡状态、\acl{T-spin}为 \acs{T-spin} 的中性氢云，
