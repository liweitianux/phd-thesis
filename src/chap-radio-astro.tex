...
和\ac{fg-avd}方法（详见 \autoref{sec:fg-methods}）来处理观测数据.
...
实现极高的灵敏度、分辨率和巡天速度 \cite{dewdney2009}.
...
\begin{figure}[htp]
  ...
  \bicaption[SKA 低频和中频天线示意图]{%
    ...
    The artist rendition of the SKA-Low dipole antennas (left panel)
    and the SKA-Mid dishes (right panel).
    \\来源/Credit:
