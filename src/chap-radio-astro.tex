...
\begin{equation}
  \label{eq:tau-g}
  \acs{tau-g} = \frac{\B{b} \cdot \hat{\B{s}}}{\acs{speed-light}},
\end{equation}
...
其相位为：
\begin{equation}
  \phi = \omega\tau_g = 2\Cpi \left( \frac{b \cos\theta}{\lambda} \right),
\end{equation}
...
\begin{equation}
  ...
  R_c = \int \acs{I-nu}(\hat{\B{s}}) \cos \left(
      \omega \B{b}\cdot\hat{\B{s}} / \acs{speed-light} \right) \,\D{\Omega}
