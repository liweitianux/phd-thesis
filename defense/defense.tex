...
\date{\small 2019 年 6 月 6 日}  % TODO
\subject{博士学位论文答辩}
\titlegraphic{%
...
\begin{frame}{研究背景和意义}
  ...
  \myfigure{%
    width=0.95\textwidth,
  }{universe-history}{宇宙演化历史 (来源: BICEP2/CERN/NASA)}
\end{frame}

%............
\begin{frame}{前景干扰难题}
  \begin{itemize}
    \item EoR 信号非常微弱，但\alert{多种前景干扰}非常强烈
...
\begin{frame}{基于深度学习的新算法}
  ...
  }{SKA1-low-psf}{SKA1-Low 在 154、158、162 MHz 处的模拟综合波束}
\end{frame}
...
\begin{frame}{数值计算方法}
  \begin{itemize}
    ...
    \item 初始电子能谱 $n_e(\gamma, t_0)$：
      ...
      在无并合的情况下演化 \SI{1}{\Gyr} \cite{brunetti2007}
    \item 每次并合的有效加速时间：
      \begin{equation}
...
\begin{frame}{SKA1-Low~阵列布局}
  \begin{columns}
    ...
    \myfigure{%
      ...
      外围区域的 36 个站点团.\\(\citeay{dewdney2016ska})
    }
  \end{columns}
\end{frame}
